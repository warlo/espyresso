...
# SENSOR
TEMPERATURE_AT_T10 = 28.06546165119687
TEMPERATURE_AT_T20 = 46.23839765510503
D10 = 10.00097554399963
HEATING_RATE = (TEMPERATURE_AT_T20 - TEMPERATURE_AT_T10) / D10

SENSOR_HEAT_CAPACITY = HEAT_CAPACITY_BODY / 1000.0  # exact value doesn't matter

SENSOR_XFER_COEFF = (
    SENSOR_HEAT_CAPACITY
    * HEATING_RATE
    / (D10 * HEATING_RATE - (TEMPERATURE_AT_T10 - AMBIENT_TEMPERATURE))
)
